    ...
    return (
        <div className="recipes__grid-item">
            <div className="recipes__grid-item-btns">
                <button className={`recipes__grid-item-btn btn btn-hover like-btn${null ? ' active' : ''}`}>
                ...
                <button className={`recipes__grid-item-btn btn btn-hover btn-bookmark${null ? ' active' : ''}`}>
